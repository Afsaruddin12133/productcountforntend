...
const Nav = () => {
    return (
        ...
        <a class="
              ...
              mr-1
            " href="#">
          <img src={"https://mdbootstrap.com/img/logo/mdb-transaprent-noshadows.png"} style={{height: "15px"}} alt="image"
            loading="lazy" />
        </a>
       
        <ul class="navbar-nav flex flex-col pl-0 list-style-none mr-auto">
          <li class="nav-item p-2">
            <a class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" href="#"><NavLink to="/">Home</NavLink></a>
          </li>
          <li class="nav-item p-2">
